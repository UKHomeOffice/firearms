  ...
  describe('instance', () => {
    ...
    describe('locals', () => {
      ...
      beforeEach(function () {
        ...
        sandbox.stub(BaseAddressController.prototype, 'mapAddresses').returns([]);
        sandbox.stub(BaseAddressController.prototype, 'hasCategories').returns(false);
      });
    ...
    describe('mapAddresses', () => {
      ...
      beforeEach(function () {
        sandbox = sinon.createSandbox();
        sandbox.stub(BaseAddressController.prototype, 'translateCategories').returns('NOT MATCHED');
      });
