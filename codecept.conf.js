...
module.exports = require('so-acceptance').extend({
  ...
  include: {
    ...
    supportingDocumentsPage: dealerPagesPath('supporting-documents-upload'),
    existingAuthorityS5Page: dealerPagesPath('existing-authority-upload'),
    invoiceContactPage: dealerPagesPath('invoice-contact-details.js'),
    ...
    existingAuthorityPage: shootingClubPagesPath('existing-authority-upload'),
    clubNamePage: shootingClubPagesPath('club-name.js'),
    newClubPage: shootingClubPagesPath('club-new.js'),
