...
Scenario('The correct form elements are present', (
  ...
  I.seeElements(contactPage['contact-group']);
  I.click(contactPage['contact-first']);
  I.click(contactPage['contact-second']);
  I.click(contactPage['contact-other']);
});
...
Scenario('first-authority-holders name is the first radio option', function *(
  ...
  yield I.refreshPage();
  I.seeElement(contactPage['contact-group']);
  I.click(contactPage['contact-first']);
  I.click(contactPage['contact-other']);
  I.dontSee(contactPage.content['second-contact-name']);
